...
sheet_tr = client.open_by_key("1RAmLhTP0Ea0B-WASvwIkVh7ENQjZSo_tzDdlzulhh3Q").worksheet("Insight Ops ")

st.title("Team Registration for InsightOPS")
...
if search_id:
    ...
    if cell_tr:
        ...
        if cell_er:
            ...
            st.write(game_list)
            st.info("Team: Min 2, Max 3 members, with one as the Team leader.")
            ...
            with st.form("Team_Reg"):
                ...
                if submit_button:
                    ...
                    w = client.open_by_key("1RAmLhTP0Ea0B-WASvwIkVh7ENQjZSo_tzDdlzulhh3Q").worksheet("Insight Ops ")
