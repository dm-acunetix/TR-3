...
sheet_tr = client.open_by_key("1VeWt6NBUGqc_4TldxqFfrw9qWhd_4n_FKM0H0XEvoLw").worksheet("DPL TR")

st.title("Team Registration for DPL")
    ...
    if cell_tr:
        ...
        if cell_er:
            ...
            with st.form("Team_Reg"):
                st.info("Team: Min 1, Max 3 members, with one as the leader.")
                ...
                if submit_button:
                    ...
                    w = client.open_by_key("1VeWt6NBUGqc_4TldxqFfrw9qWhd_4n_FKM0H0XEvoLw").worksheet("DPL TR")
