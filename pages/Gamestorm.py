...
sheet_tr = client.open_by_key("1EnkWPqyIqCawvYHn35BrvlhLxekr9pGOM-GyFCGg0Ew").worksheet("Gamestorm")
        ...
        if cell_er:
            ...
            with st.form("Team_Reg"):
                ...
                if submit_button:
                    ...
                    w = client.open_by_key("1EnkWPqyIqCawvYHn35BrvlhLxekr9pGOM-GyFCGg0Ew").worksheet("Gamestorm")
