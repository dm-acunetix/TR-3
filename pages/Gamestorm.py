...
sheet_tr = client.open_by_key("1VeWt6NBUGqc_4TldxqFfrw9qWhd_4n_FKM0H0XEvoLw").worksheet("GS TR")
    ...
    if cell_tr:
        ...
        with st.form("Team_Reg"):
            ...
            if submit_button:
                ...
                w = client.open_by_key("1VeWt6NBUGqc_4TldxqFfrw9qWhd_4n_FKM0H0XEvoLw").worksheet("GS TR")
