...
sheet_tr = client.open_by_key("1RAmLhTP0Ea0B-WASvwIkVh7ENQjZSo_tzDdlzulhh3Q").worksheet("UX Hunt")
        ...
        if cell_er is not None:
            ...
            with st.form("Team_Reg"):
                ...
                if submit_button:
                    ...
                    w = client.open_by_key("1RAmLhTP0Ea0B-WASvwIkVh7ENQjZSo_tzDdlzulhh3Q").worksheet("UX Hunt")
